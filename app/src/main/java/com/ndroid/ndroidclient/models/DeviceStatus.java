...
public class DeviceStatus {
    ...
    public String toString() {
        return "DeviceStatus [deviceId=" + deviceId + ", lock=" + lock + ", wipeData=" + wipeData +
                ", encryptStorage=" + encryptStorage + ", reboot=" + reboot + ", locationFrequency="
                + locationFrequency + ", triggered=" + triggered + "]";
    }
}
